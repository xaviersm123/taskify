...
-- Add mentions array to task_comments
ALTER TABLE task_comments 
ADD COLUMN mentioned_users uuid[] DEFAULT '{}';

-- Create function to handle mentions
...
CREATE INDEX idx_task_comments_mentioned_users ON task_comments USING gin(mentioned_users);